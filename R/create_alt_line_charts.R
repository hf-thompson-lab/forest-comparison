#' Create alternate CONUS line charts (Figs XYZ)
#' 
#' @description
#' This function produces alternate version of the three CONUS line charts in the project
...
#' These charts differ from the 3 main line charts in that the legend order matches
#' the order of line appearance, rather than alphabetical order.
#' The intention is to make the charts easier to read for people who
#' can't easily distinguish between the many colors and shapes in the graph.
#' 
...
create_alt_line_charts <- function(df){
  ...
  levs <- c('DW_trees_prob_10', 'MODIS_4_BGC', 'LCMS_all_trees_mixes',
            'LCMS_forest', 'MODIS_5_PFT', 'NLCD_canopy_10',
            'ESA_trees', 'FIA_forest', 'DW_trees_gs_mode',
            'DW_trees_prob_25', 'LCMS_trees_shrubs_mix', 'LCMS_trees',
            'DW_trees_annual_mode', 'NLCD_canopy_20', 'EPA_forest',
            'NLCD_forest_woodywet', 'LCMAP_trees_woodywet', 'ESRI_annual_trees',
            'ESRI_2020_trees', 'LCMAP_trees', 'FIA_timberland',
            'NLCD_forest', 'Hansen_GFC', 'DW_trees_prob_50',
            'NLCD_canopy_60', 'NLCD_canopy_perc', 'MODIS_3_LAI',
            'MODIS_2_UMD', 'MODIS_1_IGBP', 'NLCD_canopy_80',
            'NRI_nonfederal_forest')

  
  # Light mode colors
  light_colors <- c('DW_trees_prob_10' = '#6000c1', 'MODIS_4_BGC' = '#6fa8dc', 'LCMS_all_trees_mixes' = '#274e13',
                    'LCMS_forest' = '#0e6e5c', 'MODIS_5_PFT' = '#9fc5e8', 'NLCD_canopy_10' = '#a61c00',
                    'ESA_trees' = '#f79711', 'FIA_forest' = '#666666', 'DW_trees_gs_mode' = '#dea1fc',
                    'DW_trees_prob_25' = '#9651db', 'LCMS_trees_shrubs_mix' = '#6aa84f', 'LCMS_trees' = '#38761d',
                    'DW_trees_annual_mode' = '#b73df4', 'NLCD_canopy_20' = '#cc4125', 'EPA_forest' = '#000000',
                    'NLCD_forest_woodywet' = '#cc0000', 'LCMAP_trees_woodywet' = '#c6749f', 'ESRI_annual_trees' = '#a0e070',
                    'ESRI_2020_trees' = '#5bc10d', 'LCMAP_trees' = '#b7407b', 'FIA_timberland' = '#b7b7b7',
                    'NLCD_forest' = '#e81414', 'Hansen_GFC' = '#fc99c3', 'DW_trees_prob_50' = '#ca9af9',
                    'NLCD_canopy_60' = '#dd7e6b', 'NLCD_canopy_perc' = '#7f0000', 'MODIS_3_LAI' = '#3d85c6',
                    'MODIS_2_UMD' = '#0b5394', 'MODIS_1_IGBP' = '#073763', 'NLCD_canopy_80' = '#e6b8af', 
